...
class Conv(nn.Module):
    def __init__(self, c1, c2, k=1, s=1, p=None, g=1, act=SiLU()):  # ch_in, ch_out, kernel, stride, padding, groups
        ...
        self.conv   = nn.Conv2d(c1, c2, k, s, autopad(k, p), groups=g, bias=False)  # p == 1
...
class Backbone(nn.Module):
    def __init__(self, transition_channels, block_channels, n, phi, pretrained=False):
        ...
        # self.stem1 = Conv(3, transition_channels, 3, 1)
        # self.stem2 = Conv(transition_channels, transition_channels * 2, 3, 2)
        # self.stem3 = Conv(transition_channels * 2, transition_channels * 2, 3, 1)
